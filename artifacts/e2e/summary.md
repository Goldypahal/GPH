...
- **Run ID**: `5c4d52df`
- **Execution Timestamp**: 2026-09-10T11:34:45.628589+00:00
- **Total Duration**: 333.09 ms
...
| 5 | Anpr Ocr Normalization | **PASSED** | `('raw_text', 'GJ01ST3085')` |
| 6 | Bytetrack Tracking | **PASSED** | `('track_id', 'trk-5c4d52df-001')` |
| 7 | Canonical Sighting | **PASSED** | `('sighting_id', 'sight-5c4d52df-01')` |
| 8 | Event Bus Dispatch | **PASSED** | `('topic', 'camera.sightings')` |
| 9 | Watchlist Matching | **PASSED** | `('watchlist_id', 'ed5a5ec4-ae6c-45ec-880c-0d01fe51a174')` |
| 10 |  Alert Generation | **PASSED** | `('alert_id', 'alt-5c4d52df-01')` |
| 11 |  Websocket Fanout | **PASSED** | `('endpoint', '/ws/alerts')` |
| 12 |  Cross Camera Correlation | **PASSED** | `GEODESIC_ESTIMATE` |
| 13 |  Case Management | **PASSED** | `('case_id', 'e2f11b04-3fac-42b4-ab55-aea2bf42b0f4')` |
| 14 |  Worm Evidence Vault | **PASSED** | `('evidence_id', 'EVID-E5283B805870')` |
